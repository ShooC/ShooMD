       ...
       if(msg.message.extendedTextMessage === undefined || msg.message.extendedTextMessage === null) return msg.reply('tag orang yang ingin anda ajak bermain!')
        ...
        sesi = { 
            ...
            player1: { 
             ...
             client.sendMessage(from, { text: ` @${msg.sender.split("@")[0]} Mengajak @${PL.split("@")[0]} untuk bermain 🐍 ular tangga bersama\n\nKetik : Y [ Untuk Menyetujui]\nKetik : N [ Untuk Menolak ]`, mentions: [PL, msg.sender]},{quoted:msg})
         }
      break
      case prefix+'t':{
      ah = []
     ...
     client.DeleteMessage(ah, botNumber)
      ...
      case prefix+'welcome':{
          ...
          if (args[0] == 'ON' || args[0] == 'on' || args[0] == 'On') {
       	       if (isWelcome) return msg.reply('Sudah aktif kak')
      ...
      case prefix+'m': case prefix+'menu':{//Rfz XM
           client.sendMessage(from, { react: { text: "⏱️", key: msg.key }})
             ...
             let sourceUrl =  'https://nekopoi.care'
             let mediaUrl = 'https://nekopoi.care'                            
         ...
         case prefix+'hidetag': {
          ...
          case prefix+'pin': case prefix+'pinterest':{
           if (args.length < 1) return msg.reply('Cari gambar apa?')
             client.sendMessage(from, { react: { text: "🕰️️", key: msg.key }})
              try{
  ...
  break
   ...
   //
    ...
    if (!msg.isQuotedImage) return msg.reply('Reply gambarnya!')
     ...
     console.log(tph)
     console.log(anu)
     await client.sendMessage(from, { image: { url: anu.output_url }, caption:"Sukses!"}, { quoted: msg })
   ...
   if (!msg.isQuotedImage) return msg.reply('Reply gambarnya!') 
     ...
     console.log(anu)
        ...
        const buff = './storage_cabinets/' + ranJ        
          await client.sendMessage(from, { image: { url: buff }, caption:"Sukses!"}, { quoted: msg })
...
//
  ...
  await client.sendMessage(from, { image: medi, caption:"Sukses!"}, { quoted: msg })
   setTimeout(() => { fs.unlinkSync(buff) }, 10000)
  }
  break
